      ...
      <div style="margin-top:18px">
        ...
        <div style="background:#0f172a;border:1px solid #2d3748;border-radius:10px;padding:16px">
          <ol style="color:#94a3b8;font-size:.82rem;line-height:1.9;padding-left:1.4em;margin:0">
            <li>SSH into the Wren server: <code style="color:#f1f5f9;background:#1e293b;padding:1px 6px;border-radius:4px">ssh <admin-user>@<server-ip></code></li>
            ...
            <li>If database is unrecoverable, restore from USB: <code style="color:#f1f5f9;background:#1e293b;padding:1px 6px;border-radius:4px">rsync -a /media/wren-backup/ /app-backups/</code></li>
          </ol>
        </div>
      </div>`;
