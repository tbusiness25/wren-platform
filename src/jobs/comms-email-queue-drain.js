// Comms email queue drain — delivers queued outbound emails in comms_email_queue.
//
// BACKGROUND: survey-invite / survey-reminder rows (and any outbound comms) are
// INSERTed into comms_email_queue with status='pending' by src/routes/survey.js.
