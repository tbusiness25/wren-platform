...
<div style="max-width:560px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <div style="padding:20px 28px">
    ...
    <div style="margin-top:16px">
      <a href="https://admin.example.com" style="display:inline-block;background:#4a9abf;color:#fff;text-decoration:none;border-radius:8px;padding:10px 20px;font-size:0.85rem;font-weight:600">Open Admin Portal →</a>
    </div>
  </div>
  ...
  try {
    await db.query(
      `INSERT INTO daily_summary_log (coverage_start, coverage_end, items_count, email_to)
       VALUES ($1, $2, $3, $4)`,
      [coverageStart, coverageEnd, totalItems, 'admin@example.com']
    );
  } catch (e) {
