...
router.post('/:id/send', ...managerOnly, async (req, res) => {
  ...
  try {
    ...
    const baseUrl = process.env.ADMIN_URL || 'https://admin.example.com';
    ...
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
      ...
      await transport.sendMail({
        ...
        html: `
          ...
          <p>If you have any questions, please contact us at ${process.env.SMTP_FROM || 'admissions@example.com'} or call 01234 567890.</p>
